...
def main() -> int:
    ...
    required = ["base64.b64decode", "gzip.decompress", "hashlib.sha256", EXPECTED, "os.replace"]
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        (bad_dir / "best56.html.gz.b64.part01").write_bytes(payload)
        target = tmp / "app.html"
    ...
    print("PASS: BEST56 canonical materializer contract")
    return 0
