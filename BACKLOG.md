...
- [ ] Przywrócić odtwarzalny build `app/FlippChill_Kalkulator.html` — śledzone w #7. Release gate ma dwa niezależne artefakty: 7A canonical BEST56 i 7B historyczny BEST40. Exact BEST56 SHA-256 `3bb0756f6d3e55a0f5eeb35baec1489be4862ddddabb93c9df97acd9f4044e92` jest runtime-verified. Iteracja 38 dodała deterministyczny exact-SHA packager. Iteracja 39 wzmocniła materializer: akceptuje wyłącznie kanoniczny, ciągły zestaw `best56.html.gz.b64.part001..NNN`; obce nazwy i luki są odrzucane przed dekodowaniem. Iteracja 40 dodała CI auto-materialization: workflow #313 potwierdza krok `Materialize canonical BEST56 app when repository payload exists` = PASS i wymusza jego kolejność przed `Static application checks`. `P0-7A-CANONICAL-APP` pozostaje READY dla PRIMARY: brakującym krokiem jest zapis exact, round-trip-verified payloadu `artifacts/best56/`; po jego pojawieniu CI samo materializuje canonical app i uruchamia static check. `P0-7B-FROZEN-BEST40` pozostaje BLOCKED do exact SHA-256 `c04106fe884d32dc257d852b320f2e145a93f80e5615409dc5fac17f5b171708`.
